                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">Chỉnh sửa thông tin sản phẩm
                                    </h4>
                                </div>
                                <div class="card-body">
                                    <form class="form-valide-with-icon" action="saveEditProduct" method="POST" enctype="multipart/form-data"
                                        ...
                                        <div class="form-group">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" class="form-control" name="id_edit"
                                                           placeholder="Id sản phẩm" value="${product.productId}" readonly>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" class="form-control" name="description_edit"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" class="form-control" name="image_edit"
                                                           placeholder="Hình ảnh" value="${product.image}">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" class="form-control" name="price_edit"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" class="form-control" name="quantity_edit"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" class="form-control" name="categoryid_edit"
                                                           placeholder="Mã danh mục" value="${product.category.categoryId}">
                                                </div>
                                            </div>
